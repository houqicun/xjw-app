                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-3 b-r">
                            <h4 class="m-t-none m-b">欢迎使用~</h4>
                            <p>请输入您要查询的地名</p>
                            <form role="form" action="/WeatherForecast" method="post">
                                <div class="form-group">
                                    <label></label>
                                    <input type="text" placeholder="" class="form-control" name="cityName" id="cityName">
                                </div>
                                <div>
                                    <button class="btn btn-sm btn-primary pull-right m-t-n-xs" onclick="searchWeath()" type="button"><strong>查询</strong>
                                    </button>
                                </div>
                            </form>
                        </div>
